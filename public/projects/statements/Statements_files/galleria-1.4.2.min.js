!(function (t, e, i, n) {
      ...
      listen: function () {
        ...
        var t = function () {
          ...
          if (
            ...
            (a.msFullscreenElement && a.msFullscreenElement !== null)
          ) {
            t._enter(A.callback)
          } else {
            t._exit(A.callback)
                ...
                return function () {
                  ...
                  if (i.WEBKIT && i.TOUCH) {
                    ...
                    t.each(['left', 'top'], function (t, i) {
                      if (i in a) {
                        p[t] =
                          H.parseValue(a[i]) - H.parseValue(e.css(i)) + 'px'
                        d[i] = a[i]
                        delete a[i]
                      }
                    })
    ...
    var m = (this._fullscreen = {
      ...
      _enter: function (o) {
        ...
        var l = s.getData(),
          ...
          h = { height: '100%', overflow: 'hidden', margin: 0, padding: 0 }
        if (u) {
          s.$('container').addClass('fullscreen')
      ...
      init: function () {
        ...
        var e =
          ...
          c = {
            ...
            nextholder:
              r + 'width:50%;top:0;bottom:40px;right:-1px;cursor:pointer;',
            prev:
              r +
  ...
  i.prototype = {
    ...
    _init: function () {
      ...
      t.each(['info', 'counter', 'image-nav'], function (t, e) {
        if (
          s[
            'show' + e.substr(0, 1).toUpperCase() + e.substr(1).replace(/-/, '')
          ] === false
        ) {
    ...
    _createThumbnails: function (n) {
      ...
      var o,
        ...
        v =
          typeof u.thumbnails === 'string' ? u.thumbnails.toLowerCase() : null,
        _ = function (t) {
          ...
          e.scale({
            ...
            complete: function (e) {
              ...
              H.toggleQuality(
                e.image,
                u.thumbQuality === true ||
                  (u.thumbQuality === 'auto' && e.original.width < e.width * 3)
              )
          ...
          if (a._options.swipe) {
            ...
            t.each(new Array(a.getDataLength()), function (e) {
              var n = new i.Picture(),
                r = a.getData(e)
              t(n.container)
                .css({ position: 'absolute', top: 0, left: a._stageWidth * e })
                .prepend(
  ...
  i.raise = function (e, i) {
    var n = i ? 'Fatal error' : 'Error',
      a = { color: '#fff', position: 'absolute', top: 0, left: 0, zIndex: 1e5 },
      o = function (e) {
        var o =
    ...
    l.prototype = {
      ...
      ontouchmove: function (t) {
        ...
        if (this.isScrolling === null) {
          this.isScrolling = !!(
            this.isScrolling ||
            g.abs(this.deltaX) < g.abs(e[0].pageY - this.start.pageY)
          )
        }
        if (!this.isScrolling) {
          t.preventDefault()
      ...
      ontouchend: function (t) {
        this.touching = false
        var e =
            (+new Date() - this.start.time < 250 && g.abs(this.deltaX) > 40) ||
      ...
      t(function () {
        if (t(n).length) {
          ...
          i.utils.wait({
            ...
            error: function () {
              i.raise(
                'Init failed: Galleria could not find the element "' + n + '".'
              )
            },
            timeout: 5e3,
          })
